...
<template>
  <svg
    ...
    :aria-label="`NPI Logo - Nusantara Palm Oil`"
  >
    <!-- Palm Leaf Accent -->
    <path
    ...
    <g class="npi-logo__text">
      <!-- N -->
      <path
        d="M55 10V40M55 10L80 40M80 10V40"
        :stroke="variant === 'light' ? '#ffffff' : '#2c2416'"
        stroke-width="5"
      ...
      <!-- P -->
      <path
        d="M95 10V40M95 10H110C118 10 118 25 110 25H95M95 18H105"
        :stroke="variant === 'light' ? '#ffffff' : '#2c2416'"
        stroke-width="5"
        stroke-linecap="round"
        stroke-linejoin="round"
    ...
    <!-- Full Name (optional, for larger sizes) -->
